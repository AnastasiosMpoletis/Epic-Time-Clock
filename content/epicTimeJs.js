angular.module('rootApp', []).controller('rootCtrl', function($scope, $interval) {
 ...
 $scope.button1 = function () { return ( 
  document.body.style.backgroundImage = "url('content/backgrounds/assassinscreedBackground.jpg')",
 ...
 $scope.playAudio1 = function() { 
  var audio = new Audio('content/sounds/assassinsSound.mp3'); 
  if ($scope.toggleBool === true) audio.play(); 
 };

 // Button 2 actions - God of War
 $scope.button2 = function () { return ( 
  document.body.style.backgroundImage = "url('content/backgrounds/godofwarBackground.jpg')", 
 ...
 $scope.playAudio2 = function() { 
  var audio = new Audio('content/sounds/godofwarSound.mp3'); 
  if ($scope.toggleBool === true) audio.play(); 
 };

 // Button 3 actions - Prince of Persia
 $scope.button3 = function () { return ( 
  document.body.style.backgroundImage = "url('content/backgrounds/princeofpersiaBackground.jpg')", 
 ...
 $scope.playAudio3 = function() { 
  var audio = new Audio('content/sounds/popSound.mp3'); 
  if ($scope.toggleBool === true) audio.play(); 
 };

 // Button 4 actions - The Witcher
 $scope.button4 = function () { return ( 
  document.body.style.backgroundImage = "url('content/backgrounds/thewitcherBackground.jpg')", 
 ...
 $scope.playAudio4 = function() {
  var audio = new Audio('content/sounds/thewitcherSound.mp3'); 
  if ($scope.toggleBool === true) audio.play(); 
 };
